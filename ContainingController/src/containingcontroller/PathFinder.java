...
/**
 *@author Len
 * Class that creates map of all PathNodes
 * contains method for calculating shortest Path (Dijkstra algorithm)
 */
public class PathFinder {
    ...
    /**
     *Creates all MainRoad PathNodes and
     * connects all existing PathNodes to these MainRoad PathNodes
     */
    ...
    public List<PathNode> getShortestPath(PathNode srce, PathNode dest) throws Exception
    {
        ...
        /**
     * Calculates the shortest Path from a source to a destination by using the Dijkstra Algorithm
     * Checks each neighbor of a PathNode starting from source 
     * if neighbor-cost is larger than current-cost, neighbor-cost is current-cost, neighbor-parent is current PathNode
     * in the end loop back from destination to source by adding all parents to list
     * the list is the shortest path
     * @param srce
     * @param dest
     * @param optimize = if true-> method-call to optimize() to optimize the path
     * @return
     * @throws Exception
     */
    ...
    /**
     * optimizes the path by deleting nodes on a linear path 
     * east-east-east  will be optimized as east-east, east-north-east cant be optimized.
     * @param shortestRoute
     */
